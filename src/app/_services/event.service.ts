...
import { IEvent } from '../_interfaces/event.model';
...
const EVENTS: IEvent[] = [
	{
		...
		time: '10:00 am',
		price: 599.99,
		imageUrl: '/assets/images/View.jpg',
		location: {
			address: '1057 DT',
			city: 'London',
			country: 'England'
	...
	},
	{
		...
		time: '9:00 am',
		price: 950.0,
		imageUrl: '/assets/images/CourseBanner.jpg',
		location: {
	...
	},
	{
		...
		time: '9:00 am',
		price: 759.0,
		imageUrl: '/assets/images/MountainsWM.jpg',
		location: {
	...
	},
	{
		...
		time: '8:00 am',
		price: 800.0,
		imageUrl: '/assets/images/ScifiRoom.jpg',
		location: {
	...
	},
	{
		...
		time: '9:00 am',
		price: 400.0,
		imageUrl: '/assets/images/VegetationMeshes.jpg',
		location: {
